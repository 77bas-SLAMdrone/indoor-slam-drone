...
int main(int argc, char **argv)
{
	...
	("/joy", 1, joy_cb);
    ros::Subscriber lidar_sub = nh.subscribe<sensor_msgs::Range>("mavros/distance_sensor/hrlv_ez4_pub", 8, lidar_cb);
		...
		if( current_state.mode != "OFFBOARD" &&
			...
			if( !current_state.armed &&
				...
				if( arming_client.call(arm_cmd) &&
					...
					ROS_INFO("Take off at 1 meter... to position=(%f,%f,%f) yaw=%f",
							current_goal.position.x,
							current_goal.position.y,
